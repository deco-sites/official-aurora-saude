export const options = [
  {
    ...
    option: "MEI ou empresas<br /> de 01 a 29 vidas",
  ...
  },
  {
    id: 3,
    icon: "/Simulador/briefcase-icon.png",
    image: "/Simulador/banner3.png",
    option: "Empresas de<br /> 30 a 99 vidas",
  ...
  },
  {
    id: 4,
    icon: "/Simulador/briefcase-icon.png",
    image: "/Simulador/banner4.png",
    option: "Empresas acima<br /> de 100 vidas",
