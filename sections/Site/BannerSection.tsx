...
export default function BannerSection({ image, desktopTitle, mobileTitle, desktopText, mobileText, textColor, titleFontSize, textFontSize, titleFontWeight, textFontWeight, hasButton, buttonColor, buttonText, device, }: BannerSectionProps) {
