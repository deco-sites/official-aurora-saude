...
export default function OverlaidVideoSection({ image, title, device }: OverlaidVideoSectionProps) {
    return (<OverlaidVideoSectionIsland image={image} title={title} device={device}/>);
}
