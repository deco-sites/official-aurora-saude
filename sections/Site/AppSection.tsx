...
export default function AppSection({ desktopTitle, mobileTitle, device }: AppSectionProps) {
    return (<>
            <div id="appSection" className="flex justify-center bg-pink1">
                <div className="lg:max-w-[1400px] w-full flex flex-col lg:flex-row pt-14 pb-28 lg:pt-40 lg:pb-44">
                    <div className="lg:w-1/3 pl-14 flex flex-col gap-5 font-sora">
                        <span className="text-white text-5xl leading-tight" dangerouslySetInnerHTML={{
            __html: device === "desktop"
                ...
                : mobileTitle,
                    ...
                    <div className="relative lg:w-2/3 flex justify-center overflow-x-hidden">
                        <Image src={`${device === "desktop"
            ? "/Site/desktop-laptop-mockup.png"
            : "/Site/mobile-laptop-mockup.png"}`} alt={"Laptop"} className={`w-[862px] h-[638px] lg:w-auto lg:h-auto object-cover`}/>
                        <a href="https://aurorasaude.plataforma-beneficiario.mosiaomnichannel.com.br/#/" target="_blank">
            ...
            : "Portal do Beneficiário"}
                                <Icon class="h-auto -rotate-90" id="PinkArrowDown" strokeWidth={1} size={20}/>
                            </button>
                        </a>
