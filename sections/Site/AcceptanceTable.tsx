        ...
        <>
            <div className="flex justify-center px-10 lg:px-0">
                <div className="lg:max-w-[1400px] w-full pt-12 pb-16 lg:py-32 lg:px-40">
                    <div className="flex w-full justify-between px-20 mb-28">
                    ...
                    <div className="w-full">
                        <div class="grid grid-cols-4 text-center gap-4">
                            ...
                            <DataCellText text={"Ambulatorial e hospitalar"} />
                            <DataCellText
                        ...
                        <div className="flex flex-col gap-4">
                            {hospitals.map((hospital) => (
                                <div class="grid grid-cols-4 text-center gap-4">
                                    ...
                                    <DataCellBoolean value={hospital.a100} />
                                    <DataCellBoolean value={hospital.a300} />
                                    <DataCellBoolean value={hospital.a500} />
                                </div>
                            ))}
                        </div>
                    </div>
