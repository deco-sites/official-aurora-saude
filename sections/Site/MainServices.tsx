                    ...
                    <div className="bg-white flex flex-col gap-14 pt-20 pb-24 w-screen">
                        <div className="flex px-10 lg:px-0 lg:gap-5">
                            <div className="hidden lg:flex w-1/2 rounded-3xl">
                                <Image src={photo.src} alt={photo.alt} width={photo.width} height={photo.height} className="w-full h-full rounded-3xl object-cover"/>
                            </div>
                            <div className="lg:w-1/2 py-12 px-12 rounded-3xl flex flex-col bg-gray4 lg:pt-24 lg:pb-20 lg:px-16">
                                ...
                                <div>
                                    <ColorfullButton bgColor={"pink"} textColor={"yellow"} text={"Acesse o seu perfil"} link={device === "desktop"
            ? "https://aurorasaude.plataforma-beneficiario.mosiaomnichannel.com.br/"
            : "https://play.google.com/store/apps/details?id=br.com.mobilesaude.aurorasaude&hl=pt&gl=US&pli=1"} targetBlank/>
                                </div>
                            </div>
                        </div>
