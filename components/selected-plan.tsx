    ...
    <div className="flex justify-between bg-[#FF8461] rounded-2xl px-28 py-16">
      <div className="flex flex-col justify-between">
        <div className="flex flex-col gap-2">
          <span className="text-white text-3xl">O plano escolhido foi:</span>
          <span className="text-[#FCFF73] text-7xl font-extrabold">
            a100 rmbh
          </span>
        </div>
        <div className="flex items-baseline gap-4">
          <span className="text-sm text-white">Valor total por mês</span>
          <span className="text-white font-semibold text-xl">R$ XXX,XX</span>
        </div>
      </div>
      <div className="flex gap-4">
        <div className="flex flex-col gap-4 px-12 py-6 border-[1px] border-wite rounded-2xl text-white w-96">
        ...
        <div className="flex flex-col gap-6 px-12 py-6 border-[1px] border-[#FCFF73] rounded-2xl text-white w-64">
          <div className="flex items-center gap-2">
            <img src={"/monitor-icon.png"} alt="icon" className="w-4" />
